        ...
        <div class="row justify-content-center">
            ...
            <div class="card d-flex flex-column flex-shrink-0 p-3 bg-light shadow-sm " style="width: 210px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="empshortlist" class="d-flex nav-link link-dark active">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Shortlisted by Company') }}</div>
                                ...
                                <tbody>
                                    {{-- @foreach ($vacancy as $item) --}}
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>xyz</td>
                                                <td><span class="badge bg-info text-dark">Shortlisted</span></td>
