        ...
        <div class="row justify-content-center">
            ...
            <div class="card d-flex flex-column flex-shrink-0 p-3 bg-light shadow-sm " style="width: 210px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="/dashboard" class="d-flex nav-link link-dark ">
                            <i class="material-icons md-18 me-2">dashboard</i> <span>Dashboard</span></a>
                    </li>
                    <li>
                        <a href="/profile" class="d-flex nav-link link-dark ">
                            <i class="material-icons md-18 me-2">person</i> <span>Proflie</span></a>
                    </li>
                    <li>
                        <a href="/alljobs" class="d-flex nav-link link-dark ">
                            <i class="material-icons md-18 me-2">work</i> <span>Jobs</span></a>
                    </li>
                    <li>
                        <a href="empapplied" class="d-flex nav-link link-dark active">
                            <i class="material-icons md-18 me-2">check</i> <span>Jobs Applied</span></a>
                    </li>
                    <li>
                        <a href="empshortlist" class="d-flex nav-link link-dark ">
                            <i class="material-icons md-18 me-2">list</i> <span>Shortlisted</span></a>
                    </li>
                    <li>
                        <a href="emprejected" class="d-flex nav-link link-dark ">
                            <i class="material-icons md-18 me-2">close</i> <span>Rejected</span></a>
                    </li>
                    {{-- <li>
                            ...
                            <table class="table table-bordered table-hover table-sm  text-center">
                                <thead class="">
                                    <tr>
                                        ...
                                        <th scope="col">Last Date For Apply</th>
                                    ...
                                    {{-- @foreach ($vacancy as $item) --}}
                                        <tr>
                                            ...
                                            {{-- @if ($item->expiray_date > now()->toDateTimeString()) --}}
                                                <td><span class="badge bg-success">2022-03-30</span></td>
                                                <td>
                                                    Active
                                                </td>
                                            {{-- @elseif ($item->expiray_date == now()->toDateString()) --}}
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-info" href="/{{ $item->id }}">Apply</a>
                                                </td>
                                            {{-- @else --}}
                                                {{-- <td><span class="badge bg-danger">{{ $item->expiray_date }}</span></td>
                                                <td>
                                                    <a class="btn btn-xs btn-secondary disabled" href="">Apply</a>
                                                </td> --}}
                                                {{-- @endif --}}
