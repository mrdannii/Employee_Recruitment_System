        ...
        <div class="row justify-content-center">
            ...
            <div class="card d-flex flex-column flex-shrink-0 p-3 bg-light shadow-sm " style="width: 210px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="/alljobs" class="d-flex nav-link link-dark active">
                            <i class="material-icons md-18 me-2">work</i> <span>Jobs</span></a>
                    </li>
                    <li>
                        <a href="empapplied" class="d-flex nav-link link-dark ">
                                    ...
                                    @foreach ($vacancy as $item)
                                        <tr>
                                            ...
                                            @if ($item->expiray_date > now()->toDateTimeString())
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-primary" href="/{{ $item->id }}">Apply</a>
                                                </td>
