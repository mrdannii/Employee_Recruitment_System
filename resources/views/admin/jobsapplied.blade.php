                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        ...
                        <div class="collapse show" id="dashboard-collapse2">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="/applied" class="d-flex nav-link link-dark rounded active">Jobs Applied <span
                                            class="material-icons md-18 ms-1">
                                            check_circle
                                        </span></a></li>
                                ...
                                <tbody>
                                    {{-- @foreach ($vacancy as $item) --}}
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>xyz</td>
                                            <td class="w-25"><a href="" class="btn btn-sm btn-link">Show Details</a></td>
                                            <td class="w-25">
                                                <a class="btn btn-xs btn-warning" href=""> Shortlist </a>
