                    ...
                    <li>
                        ...
                        <div class="collapse show" id="dashboard-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="/createjob" class="d-flex nav-link link-dark rounded active">Create Job <span
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body shadow-sm">
                        ...
                        <form class="text-center justify-content-center" action="submitjob" method="POST">
                            @csrf
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-sm-5">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" required name="description"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-sm-5">
                                    <input type="date" class="form-control text-center" id="inputEmail3" name="expiray" required>
                                </div>
                            </div>
